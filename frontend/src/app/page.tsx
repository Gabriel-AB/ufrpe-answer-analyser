  ...
  return (
    <main className="flex flex-col h-dvh gap-8 items-center justify-center">
      <div className="flex flex-wrap gap-8 items-center justify-center w-full">
        ...
        <div className="flex flex-col relative w-96 border-zinc-300 shadow-lg shadow-zinc-400 rounded-lg overflow-y-auto">
      ...
      <button className="bg-zinc-200 rounded-lg py-2 px-4 shadow-lg shadow-zinc-400 hover:bg-zinc-300 active:bg-zinc-400 active:translate-y-px">
        Avaliar
      </button>
    </main>
  );
